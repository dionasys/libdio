...
#set output "function_adaptation_cw_to_ccw_nochurn_job_349.eps"
...
#plot '../data/350/tman1_view_convergence_job_350_cw.dat' using 1:4 with lines linestyle 1 t 'initial function cw' , '../data/350/tman1_view_convergence_job_350_ccw.dat' u 1:4 with lines linestyle 2 t 'replacing function ccw',  '../data/350/computed_function_propagation_350.dat' u 2:6 with lines linestyle 3 t 'function dissemination', '../data/339/computed_function_propagation_339.dat' u 2:6 with lines linestyle 4 t 'function dissemination (old1)', '../data/349/computed_function_propagation_349.dat' u 2:6 with lines linestyle 5 t 'function dissemination (old2)'

plot '../data/351/tman1_view_convergence_job_351_cw.dat' using 1:4 with lines linestyle 1 t 'initial function cw' , '../data/351/tman1_view_convergence_job_351_ccw.dat' u 1:4 with lines linestyle 2 t 'replacing function ccw',  '../data/351/computed_function_propagation_351.dat' u 2:6 with lines linestyle 3 t 'function dissemination (tt7 7)', 
